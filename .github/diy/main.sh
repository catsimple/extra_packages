...
git clone --depth 1 https://github.com/catsimple/luci-app-diskman diskman && mv -n diskman/applications/* ./;rm -rf diskman
...
git clone --depth 1 https://github.com/nikkinikki-org/OpenWrt-nikki openwrt_nikki && mv -n openwrt_nikki/luci-app-nikki openwrt_nikki/nikki openwrt_nikki/mihomo-alpha openwrt_nikki/mihomo-meta ./;rm -rf openwrt_nikki
...
git clone --depth 1 https://github.com/catsimple/luci-app-temp-status
